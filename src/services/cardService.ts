...
let mockCard: HavenCardState = {
  id: 'crd_hvn_visa_01',
  scheme: 'visa_debit',
  programmeName: 'Haven · Visa Debit',
  lastFour: '4829',
  expiryMonth: '08',
  expiryYear: '28',
  status: 'active',
...
export const cardService: CardService = {
  ...
  async requestPinReveal() {
    ...
    return {
      obfuscatedLastTwo: '••',
      mockNote:
        'For your security, your full PIN would be shown briefly after biometric sign-in — follow the prompts on screen.',
    };
  },
  ...
  async requestReplacement(reason) {
    await mockDelay();
    void reason;
    return { reference: 'HVN-CARDREP-88421' };
  },
};
